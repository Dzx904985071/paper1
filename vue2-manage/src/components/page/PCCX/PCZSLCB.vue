<template>
    <div style="height:100%;width:100%;" class="table" @click="closeclick">
        ...
        <div class="flex">
            ...
            <div class="flex roundBox">
                <div class="round zhijian " style="margin-top: 5px;border: 2px dashed #1578DA;background: #0A1F3B;"></div>
                <div class="text">弱关联</div>
            </div>
        </div>
                ...
                <div id="overbox" v-if="oversnake" class="text" :style="{top:overy+'px',left:overx+'px'}">
                    <div style="padding: 15px;
                     ...
                     border: 1px #3C7DE7 solid;">
                        ...
                        <i v-if="overData.isys == '1'" class="iconfont iconxingzhuang" @click="tocarvens()"></i>
                        <i v-else style="display:none"></i></p>
                    </div>
                </div>
                            ...
                            <div class="flex">
                                <div class="codeBox" style="width: 100%;">
                                    <div v-if="item.current=='true'" class="textblack" style="width: 100%;">
                                        <div v-if="item.black==='0'">
                                            <div v-if="item.isys == '1'" class="text heiliaosyzj" style="
                                            ...
                                            <div v-else class="text heiliaosy" style="
                                             margin: 10px;min-width: 110px;padding: 10px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                        ...
                                        <div v-else-if="item.black==='1'">
                                            <div v-if="item.isys == '1'" class="text bailiaosyzj" style="
                                            ...
                                            <div v-else class="text bailiaosy" style="
                                             margin: 5px 4px;min-width: 120px;padding: 13px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                        ...
                                        <div v-else-if="item.black==='2'">
                                            <div v-if="item.isys == '1'" class="text hunliaosyzj" style="
                                             margin: 10px;min-width: 110px;padding: 10px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                            ...
                                            <div v-else class="text hunliaosy" style="
                                             margin: 10px;min-width: 110px;padding: 10px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                    ...
                                    <div v-else-if="item.black==='0'" class="textblack" style="width: 100%;">
                                        <div v-if="item.isys == '2'" class="text heiliaorgl" style="
                                             margin: 10px;min-width: 110px;padding: 10px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                        ...
                                        <div v-else-if="item.isys == '1'" class="text heiliaozj" style="
                                             margin: 10px;min-width: 110px;padding: 10px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                        ...
                                        <div v-else class="text heiliaomr" style="
                                             margin: 10px;min-width: 110px;padding: 10px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                    ...
                                    <div v-else-if="item.black==='1'" class="textblack" style="width: 100%;">
                                        <div v-if="item.isys == '2'" class="text bailiaorgl" style="
                                             margin: 10px;min-width: 110px;padding: 10px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                        ...
                                        <div v-else-if="item.isys == '1'" class="text bailiaozj" style="
                                             margin: 10px;min-width: 110px;padding: 10px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                        ...
                                        <div v-else class="text bailiaomr" style="
                                             margin: 10px;min-width: 110px;padding: 10px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                    ...
                                    <div v-else-if="item.black==='2'" class="textblack" style="width: 100%;">
                                        <div v-if="item.isys == '2'" class="text hunliaorgl" style="
                                             margin: 10px;min-width: 110px;padding: 10px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                        ...
                                        <div v-else-if="item.isys == '1'" class="text hunliaozj" style="
                                             margin: 10px;min-width: 110px;padding: 10px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                        ...
                                        <div v-else class="text hunliaomr" style="
                                             margin: 10px;min-width: 110px;padding: 10px;
                                             line-height: 15px;"
                                             @dblclick="viewXQ(item)"
                                             @contextmenu.prevent="overclick(item)">
                                    ...
                                    <div v-if="item.checkInformation.length>0">
                                        <div v-for="(item1,i1) in item.checkInformation" :key="i1">
                                            <div v-if="item1.current==='true'" class="textblack" style="width: 100%;">
                                                <div v-if="item1.black==='0'">
                                                    <div v-if="item1.isys == '1'" class="text heiliaosyzj" style="
                                                 margin: 10px;min-width: 110px;padding: 10px;
                                                 line-height: 15px;"
                                                ...
                                                <div v-else-if="item1.black==='1'">
                                                    <div v-if="item1.isys == '1'" class="text bailiaosyzj" style="
                                                 margin: 5px 4px;min-width: 120px;padding: 13px;
                                                 line-height: 15px;"
                                                     @dblclick="viewXQ(item1)"
                                                     @contextmenu.prevent="overclick(item1)">
                                                ...
                                                <div v-else-if="item1.black==='2'">
                                                    <div v-if="item1.isys == '1'" class="text hunliaosyzj" style="
                                                 margin: 10px;min-width: 110px;padding: 10px;
                                                 line-height: 15px;"
                                                     @dblclick="viewXQ(item1)"
                                                     @contextmenu.prevent="overclick(item1)">
                                            ...
                                            <div v-else class="textblack" style="width: 100%;">
                                                <div v-if="item1.black==='0'" >
                                                    <div v-if="item1.isys == '2'" class="text heiliaorgl" style="
                                                 margin: 10px;min-width: 110px;padding: 10px;
                                                 line-height: 15px;"
                                                     @dblclick="viewXQ(item1)"
                                                     @contextmenu.prevent="overclick(item1)">
                                                    ...
                                                    <div v-else-if="item1.isys == '1'" class="text heiliaozj" style="
                                                 margin: 10px;min-width: 110px;padding: 10px;
                                                 line-height: 15px;"
                                                     @dblclick="viewXQ(item1)"
                                                     @contextmenu.prevent="overclick(item1)">
                                                ...
                                                <div v-else-if="item1.black==='1'" >
                                                    <div v-if="item1.isys == '2'" class="text bailiaorgl" style="
                                                 margin: 10px;min-width: 110px;padding: 10px;
                                                 line-height: 15px;"
                                                     @dblclick="viewXQ(item1)"
                                                     @contextmenu.prevent="overclick(item1)">
                                                    ...
                                                    <div v-else-if="item1.isys == '1'" class="text bailiaozj" style="
                                                 margin: 10px;min-width: 110px;padding: 10px;
                                                 line-height: 15px;"
                                                     @dblclick="viewXQ(item1)"
                                                     @contextmenu.prevent="overclick(item1)">
                                                ...
                                                <div v-else-if="item1.black==='2'">
                                                    <div v-if="item1.isys == '2'" class="text hunliaorgl" style="
                                                 margin: 10px;min-width: 110px;padding: 10px;
                                                 line-height: 15px;"
                                                     @dblclick="viewXQ(item1)"
                                                     @contextmenu.prevent="overclick(item1)">
                                                    ...
                                                    <div v-else-if="item1.isys == '1'" class="text hunliaozj" style="
                                                 margin: 10px;min-width: 110px;padding: 10px;
                                                 line-height: 15px;"
                                                     @dblclick="viewXQ(item1)"
                                                     @contextmenu.prevent="overclick(item1)">
...
<!--                                <img v-if="index+1!==tableDatas.length" :src="jiantou" class="jiantou"/>-->
                    ...
                    <el-table :data="tableDataXQ" style="width: 100%;" ref="multipleTable"
                        ...
                        <el-table-column label="操作" width="130px">
                                <template slot-scope="scope">
                                    <section class="table_button" @click="seejyxq(scope.row)" size="small">详情</section>
                                </template>
                            </el-table-column>
                    </el-table>
                    <div>
        ...
        <div class="mack" v-if="pclcjyxq">
                <div><i class="iconfont iconguanbi close" @click="goup"></i>
                </div>
                <div
                    style="
                    height: 16px;
...
<script>
    ...
    import jyxq from './xq/jyxq'
import Jyxq from './xq/jyxq.vue'
    export default {
        components: {
    jyxq,
  },
        ...
        methods: {
            seejyxq(item)
            {
                this.fcpmxData=item.batchNumber
                this.pclcjyxq=true
            },
            goup(){
                this.pclcjyxq=false
