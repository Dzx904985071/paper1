<template>
    <div style="height: 100%; width: 100%" class="table">
        <div class="searchForm padding">
            ...
            <div class="searchInputs">
                <p>开始工序</p>
                <el-select v-model="searchForm.ksgx" :popper-append-to-body="false" placeholder="请选择">
                    <el-option
            ...
            <div class="searchInputs">
                <p>结束工序</p>
                <el-select v-model="searchForm.jsgx" :popper-append-to-body="false" placeholder="请选择">
                    <el-option
                            v-for="item in gxOptions"
                            :key="item.specificationID"
                            :label="item.specificationCode + '-' + item.specificationName"
            ...
            <div class="searchDiv3">
                ...
                <section class="query_button" @click="query" size="small">
                    查询
                </section>
            </div>
        </div>
        <div style="display: flex; margin-top: 15px; height: calc(100% - 125px)">
            <div
                    class="baseTable padding"
                    style="width: 70%; height: calc(100% - 20px)"
            >
                    ...
                    >
                        ...
                        >
                            <template slot-scope="scope">
                                <div style="color:#1888fa;"
                                     v-if="scope.row.productName==''||scope.row.productName==null">
                                    {{scope.row.workshop}}
                                </div>
                                <div v-else>
                                    {{scope.row.workshop}}
                        ...
                        >
                            <template slot-scope="scope">
                                <div v-if="scope.row.productName==''||scope.row.productName==null">
                                    <span style="color:#1888fa;">{{scope.row.numberOfInput}}</span>
                                </div>
                                <div v-else>
                        ...
                        >
                            <template slot-scope="scope">
                                <div style="color:#1888fa;"
                                     v-if="scope.row.productName==''||scope.row.productName==null">
                                    <span>{{scope.row.theoryOutput}}</span>
                                </div>
                                <div v-else>
                        ...
                        >
                            <template slot-scope="scope">
                                <div v-if="scope.row.productName==''||scope.row.productName==null">
                                    <span style="color:#1888fa;">{{scope.row.actualOutput}}</span>
                                </div>
                                <div v-else>
                        ...
                        >
                            <template slot-scope="scope">
                                <div v-if="scope.row.productName==''||scope.row.productName==null">
                                    <span style="color:#1888fa;">{{scope.row.untestedOutput}}</span>
                                </div>
                                <div v-else>
                                    {{scope.row.untestedOutput}}
                                </div>
                            </template>
                        </el-table-column>
                        <el-table-column
                        ...
                        >
                            <template slot-scope="scope">
                                <div v-if="scope.row.productName==''||scope.row.productName==null">
                                    <span style="color:#1888fa;">{{scope.row.workInProcess}}</span>
                                </div>
                                <div v-else>
                        ...
                        >
                            <template slot-scope="scope">
                                <div v-if="scope.row.productName==''||scope.row.productName==null">
                                    <span style="color:#1888fa;">{{scope.row.outputNumber}}</span>
                                </div>
                                <div v-else>
                                    {{scope.row.outputNumber}}
                                </div>
                            </template>
                        </el-table-column>
                        <el-table-column
                        ...
                        >
                            <template slot-scope="scope">
                                <div v-if="scope.row.productName==''||scope.row.productName==null">
                                    <span style="color:#1888fa;">{{scope.row.coproductNumber}}</span>
                                </div>
                                <div v-else>
                        ...
                        >
                            <template slot-scope="scope">
                                <div v-if="scope.row.productName==''||scope.row.productName==null">
                                    <span style="color:#1888fa;">{{scope.row.spUseYield}}</span>
                                </div>
                                <div v-else>
                        ...
                        >
                            <template slot-scope="scope">
                                <div v-if="scope.row.productName==''||scope.row.productName==null">
                                    <span style="color:#1888fa;">{{scope.row.rolledYield}}</span>
                                </div>
                                <div v-else>
                        ...
                        >
                            <template slot-scope="scope">
                                <div v-if="scope.row.productName==''||scope.row.productName==null">
                                    <span style="color:#1888fa;">{{scope.row.rolledThroughputYield}}</span>
                                </div>
                                <div v-else>
                        ...
                        >
                            <template slot-scope="scope">
                                <div v-if="scope.row.productName==''||scope.row.productName==null">
                                    <span style="color:#1888fa;">{{scope.row.coproductYield}}</span>
                                </div>
                                <div v-else>
                        ...
                        >
                            <template slot-scope="scope">
                                <div v-if="scope.row.productName==''||scope.row.productName==null">
                                    <span style="color:#1888fa;">{{scope.row.synthesisYield}}</span>
                                </div>
                                <div v-else>
        ...
        "
            >
                <div style="padding: 30px 0px 0px 10px; font-size: 16px">
                ...
                <div>
                    <div class="basediv">
                        <span>直通率</span><span class="showdiv">{{ rolledYield+'%' }}</span>
                    </div>
                    <div class="basediv">
            <span>综合收率</span
            ...
            ><span class="showdiv">{{ byproductYield+'%' }}</span>
                    ...
                    <div class="basediv">
                        <span>SP产品率</span><span class="showdiv">{{ spUseYield+'%' }}</span>
                    </div>
                    <div class="basediv">
            <span>综合产率</span
...
<script>
    import {
        JCSJ_getVSite,
        JHDC_ProductionOIselectPage,
        JHDC_ProductionOIworkselectList,
    ...
    export default {
        ...
        methods: {
            ...
            reset() {
                ...
                this.searchForm.ksgx = ''
                this.searchForm.jsgx = ''
                this.searchForm.rq = []
                // this.searchForm.cj=""
            ...
            getMsg() {
                ...
                const para = {
                    ...
                    gx: this.searchForm.ksgx,
                    gxx: this.searchForm.jsgx,
                };
                JHDC_ProductionOIselectPage(para).then((res) => {
                    if (res.code == 200) {
            ...
            getMsgCj() {
                ...
                JHDC_ProductionOIworkselectList(para).then((res) => {
                    if (res.code == 200) {
