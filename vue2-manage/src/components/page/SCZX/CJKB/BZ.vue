    ...
    <div style="height:100%;width:100%;">
        <div class="cj_background" >
            ...
            <div style="height:80%;" class="table_background">
                ...
                <div style="width:62.6%;height:100%">
                    <table class="table" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;border-top: 1px solid #1888FA;border-left: 1px solid #1888FA;">
                        <tr class="tr-boder table_body" >
                            <th class="th">生产线号</th>
                            <th class="th">包装设备状态</th>
                        </tr>
                        <tr class="tr-boder"  v-for="(cm,index) in  tabledDate" :key="index+''" @click="get(cm,index)">
                            ...
                            <td class="td"><template>
                                <div v-if="cm.packageState=='运行'" class="rectangleyx"></div>
                                <div v-if="cm.packageState=='故障'" class="rectanglegz"></div>
                                <div v-if="cm.packageState=='待机'" class="rectangledj"></div>
                                <div v-if="cm.packageState=='停止'" class="rectangletz"></div>
                                </template></td>
                        </tr>
                        </table>
                </div>
                <div style="color:#FFFFFF;font-size:20px;width:31.3%;" class="bszt_header">
                    <div class="bszt_body">
                        <div style="display:table-cell;background:#1888FA; vertical-align:middle;">
                            状态标识
                        </div>
                    </div>
                    <div style="height:20.8%;">
            ...
            <!-- <div style="text-align: center;padding-top:10px">
                    <span class="bottomwite">车间温度T&nbsp;&nbsp;</span><span class="bottomred">{{temperature}}</span><span class="bottomwite">&nbsp;&nbsp;℃</span>
                    <span class="bottomwite">&nbsp;&nbsp;&nbsp;车间湿度H&nbsp;&nbsp;</span><span class="bottomred">{{humidity}}</span><span class="bottomwite">&nbsp;&nbsp;%</span>
                </div> -->
...
import './cjkb.css'
import bus from '../../../../bus'
import {CJKB_selectPackage} from '../../../../api/yjl'
export default {
    data(){
        return{
           showtime:'',
    ...
    methods:{ 
        ...
        getMsg(){
            ...
            CJKB_selectPackage(para).then(res=>{
                if(res.code==200)
                {
...
.th {
  ...
  border-bottom: 1px solid #1888fa;
}
</style>