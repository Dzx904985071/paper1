    ...
    <div style="height:100%;width:100%;">
        <div  class="cj_background">
            ...
            <div style="height:80%;" class="table_background">
                    ...
                    <table class="table" style="border-collapse:collapse;border-top: 1px solid #1888FA;border-left: 1px solid #1888FA;">
                        ...
                        <tr class="tr-boder"  v-for="(cm,index) in  tabledDate" :key="index+''" @click="get(cm,index)">
                            ...
                            <td class="td"><template>
                                <div v-if="cm.state=='运行'" class="rectangleyx"></div>
                                <div v-if="cm.state=='故障'" class="rectanglegz"></div>
                                <div v-if="cm.state=='待机'" class="rectangledj"></div>
                                <div v-if="cm.state=='停止'" class="rectangletz"></div>
                                </template>
                                </td>
                ...
                <div style="color:#FFFFFF;font-size:20px;width:25%;" class="bszt_header">
                    <div class="bszt_body">
...
<script>
import {CJKB_selectBroken} from '../../../../api/yjl'
import bus from '../../../../bus'
import './cjkb.css'
export default {
    data(){
    ...
    methods:{
        ...
        getMsg(){
            ...
            CJKB_selectBroken(para).then(res=>{
                if(res.code==200)
                {
