    ...
    <div style="height:100%;width:100%;">
        <div  class="cj_background">
            ...
            <div style="height:80%;" class="table_background">
                ...
                <div style="width:75.2%;height:100%">
                ...
                <div style="color:#FFFFFF;font-size:20px;width:18.8%;" class="bszt_header">
                    <div class="bszt_body">
...
import './cjkb.css'
import bus from '../../../../bus'
import {CJKB_selectFeeding} from '../../../../api/yjl'
export default {
    data(){
        return{
           showtime:'',
    ...
    methods:{
        ...
        getMsg(){
            ...
            CJKB_selectFeeding(para).then(res=>{
                if(res.code==200)
                {
