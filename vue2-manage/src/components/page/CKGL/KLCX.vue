        ...
        <transition name="move" mode="out-in">
            <div v-if="count === 0" key="0">
                    ...
                    <div style="overflow-y:auto">
                        <el-table :data="tableData" style="width: 100%;" ref="multipleTable"
                            ...
                            <el-table-column prop="specifications" label="规格型号" min-width="120"
                                             show-overflow-tooltip></el-table-column>
                            <el-table-column prop="totalWeight" sortable label="总重量" min-width="120"
                                             show-overflow-tooltip></el-table-column>
                            <el-table-column
                ...
                >
                    ...
                    <div class="eltabs">
                        <KLCXXQ :fcpmxData="fcpmxData"></KLCXXQ>
                    </div>
            </div>           
            </div>
        </transition>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            viewXQ(row) {
                this.klcxxq = true
                this.fcpmxData.productionId=row.warehouseAgeId
